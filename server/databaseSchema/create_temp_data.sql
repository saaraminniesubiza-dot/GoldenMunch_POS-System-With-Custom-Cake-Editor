...
-- Simple V3 INSERT - trigger auto-sets item_total=subtotal
INSERT INTO order_item (order_id, menu_item_id, item_name, quantity, unit_price, subtotal) VALUES
...
-- Custom cake example with V2 compatibility fields (if needed later)
-- For now, using simple V3 format
INSERT INTO order_item (order_id, menu_item_id, item_name, quantity, unit_price, subtotal) VALUES
(3, 2, 'Vanilla Birthday Cake (Custom)', 1, 1200.00, 1200.00); -- Custom Birthday Cake
